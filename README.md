A simple yet engaging Tic Tac Toe game built with HTML, CSS, and JavaScript. This two-player game allows users to compete in a classic 3x3 grid format, complete with:
